...
#define LCD_RS_PIN	2 	//define MCU pin connected to LCD RS
#define LCD_RS_DDR	DDRC
#define LCD_RS_PORT	PORTC

#define LCD_RW_PIN	3 	//define MCU pin connected to LCD R/W
#define LCD_RW_DDR	DDRC
#define LCD_RW_PORT	PORTC

#define LCD_EN_PIN	4	//define MCU pin connected to LCD E
#define LCD_EN_DDR	DDRC
#define LCD_EN_PORT	PORTC

#define LCD_D4_PIN	5	//define MCU pin connected to LCD D4
#define LCD_D4_DDR	DDRC
#define LCD_D4_PORT	PORTC

#define LCD_D5_PIN	6	//define MCU pin connected to LCD D5
#define LCD_D5_DDR	DDRC
#define LCD_D5_PORT	PORTC

#define LCD_D6_PIN	7	//define MCU pin connected to LCD D6
#define LCD_D6_DDR	DDRC
#define LCD_D6_PORT	PORTC

#define LCD_D7_PIN	4	//define MCU pin connected to LCD D7
